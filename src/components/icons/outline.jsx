/* ═══════════════════════════════════════════════════════════════════════════
   Outline icon set — plain stroke icons, 1.5px stroke, currentColor.

   Every icon here uses stroke="currentColor" (not a hardcoded hex) so it
   inherits whatever color the surrounding component applies — same rule as
   every other icon in this design system (see src/index.css comment).

   Each entry's `id` is the stable id used in the "Copy ID" button on the
   Icon Library page and matches the `icon-<id>` anchor in ICONS.md at the
   repo root — that's where the exact SVG for `ds:icon-<id>` lives for an
   agent to look up.
   ═══════════════════════════════════════════════════════════════════════════ */
